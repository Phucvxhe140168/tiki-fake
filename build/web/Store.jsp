<%-- 
    Document   : Store
    Created on : Jun 30, 2021, 9:05:33 AM
    Author     : Vu X Phuc
--%>
...
<html lang="en">
    ...
    <body>
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div  id="tailen" class="row">
                            <c:forEach items="${listP}" var="o">
                                <!-- product -->
                                <div class=" Productnum col-md-4 col-xs-6 ">
                                    <div class="product">
                                        <div class="product-img">
                        ...
                        <button onclick="loadMore()"  style=" width: 100%; margin-top: 20px" class="btn btn-info" >Load More</button>
                        <!-- /store products -->
                    </div>
                    <!-- /STORE -->
                </div>
        ...
        <script>
                            function loadMore() {
                                var number = document.getElementsByClassName("Productnum").length;
                                $.ajax({
                                    url: "/Tiki-fake/LoadMore",
                                    type: "Post",
                                    data: {
                                        numProduct: number
                                    },
                                    success: function (data) {
                                        var row = document.getElementById("tailen");
                                        row.innerHTML += data;
                                    },
                                    error: function (er) {
